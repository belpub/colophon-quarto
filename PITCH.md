...
**Also now packaged as a proper Quarto project-type extension** — `quarto add belpub/colophon-quarto` adds just the engine to an existing project, or clone the whole repo for the full starter template with example content included.
